<?php 
  ...
  if ($_SERVER['HTTP_HOST'] == "localhost") {
      $folder_name = ""; $path = 'https://localhost/paperhelpdeskfull'.$folder_name;
  } else {
      ...
      <div class="container"> 
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"> 
            ...
            <a class="navbar-brand" href="<?php echo $path;?>"><img src="<?php echo $basesurl;?>images/paper-help-desk.svg" alt="Papaperhelpdesk" /></a> 
        </div>
